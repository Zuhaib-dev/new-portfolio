      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Zuhaib Rashid</h1>
            <p className="text-lg sm:text-xl text-muted-foreground">Web Developer</p>
          </div>
