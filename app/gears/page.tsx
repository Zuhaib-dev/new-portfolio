    ...
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mb-10">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-3xl font-bold">Gears</h1>
        </div>
        <p className="text-muted-foreground">
          Tools, devices, and software I use to get work done.
        </p>
      </div>
          ...
          {devices.map((device, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex items-center gap-2 min-w-0 py-3 border-b border-border/50 group-last:border-0 hover:bg-muted/10 px-2 rounded-lg transition-colors cursor-pointer">
                  <p className="font-medium text-sm text-foreground/80 group-hover:text-foreground transition-colors">{device.name}</p>
                  <a href={device.link} target="_blank" rel="noreferrer" className="text-muted-foreground/50 hover:text-foreground transition-colors">
